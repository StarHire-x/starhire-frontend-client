...
import { getACorporateJobListingBreakdown, getCorporateJobListingStats } from "@/app/api/auth/user/route";
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const fetchBreakdown = async () => {
        ...
        const information = await getCorporateJobListingStats(userId, accessToken)
   ...
   useEffect(() => {
     ...
     const fetchBreakdown = async () => {
       const breakdownInfo = await getACorporateJobListingBreakdown(userId, accessToken)
