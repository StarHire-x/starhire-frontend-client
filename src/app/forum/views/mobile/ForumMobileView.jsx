  ...
  return (
    <>
      <div className={styles.pageHeader}>
        <h2>Forum</h2>
        <Button className={styles.infoButton} icon="pi pi-info" rounded onClick={() => setGuideLinesVisibility(true)} />
      </div>

      <div className={styles.pageContainer}>
        <Dialog header="Forum Community Guidelines" visible={guideLinesVisibility} onHide={() => setGuideLinesVisibility(false)}>
            <ForumGuidelinesCard/>
        </Dialog>
